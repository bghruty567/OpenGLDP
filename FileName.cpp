...
//VTK_MODULE_INIT(vtkRenderingOpenGL2);  // 核心渲染模块
//VTK_MODULE_INIT(vtkInteractionStyle);   // 交互控制模块
//VTK_MODULE_INIT(vtkRenderingFreeType);  // 文本渲染（如需显示文字）
//
//// Note that:
...
//    std::string filename = "uGridEx.vtk";
...
//
//	VTKDataConverter Converter;
//
//	Converter.bindVTKDataAndInternalData(reader->GetOutput(),dataObject1);
//	Converter.convertVTKToInternal();
//
//
